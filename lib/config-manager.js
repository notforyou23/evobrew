...
const DEFAULT_CONFIG = {
  ...
  providers: {
    ...
    ollama: {
      ...
      default_model: null,  // User's preferred model (e.g., 'llama3.2')
      auto_detect: true  // if true, check if Ollama running on startup
    },
    lmstudio: {
      enabled: false,
      base_url: 'http://localhost:1234/v1',
      default_model: null  // User's preferred model
    }
  },
  preferences: {
    prefer_local: false  // Use local models as primary when available
  },
  openclaw: {
    enabled: false,
