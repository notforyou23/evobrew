...
function validateConfig(config) {
  ...
  const hasProvider = config.providers && (
    (config.providers.openai?.enabled && (config.providers.openai?.api_key || (Array.isArray(config.providers.openai?.models) && config.providers.openai.models.length > 0))) ||
    (config.providers.anthropic?.enabled && ((config.providers.anthropic?.api_key || config.providers.anthropic?.oauth) || (Array.isArray(config.providers.anthropic?.models) && config.providers.anthropic.models.length > 0))) ||
    (config.providers.xai?.enabled && (config.providers.xai?.api_key || (Array.isArray(config.providers.xai?.models) && config.providers.xai.models.length > 0))) ||
    (config.providers.ollama?.enabled && Array.isArray(config.providers.ollama?.models) && config.providers.ollama.models.length > 0) ||
    (config.providers.lmstudio?.enabled && Array.isArray(config.providers.lmstudio?.models) && config.providers.lmstudio.models.length > 0) ||
    (config.providers['openai-codex']?.enabled && Array.isArray(config.providers['openai-codex']?.models) && config.providers['openai-codex'].models.length > 0)
  );
